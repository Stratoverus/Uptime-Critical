...
func _rebuild_event_definitions() -> void:
	EVENTS = {
        ...
        "grand_opening": {
            ...
            "demand_mult": 1.2,
            "ddos_add": 0.0,
            "message": "Day 1 is live! Marketing is pushing traffic to your new servers. Monitor the load and ensure a smooth launch.",
            "seen_before": false,
            "event_is_good": true
        },
        "black_friday": {
            ...
            "demand_mult": 2.0,
            "ddos_add": 0.0,
            "message": "Holiday shopping frenzy! Retail clients are seeing massive spikes. Expect sustained, heavy load across all clusters today.",
            "seen_before": false,
            "event_is_good": true
        },
        "cyber_monday": {
            ...
            "demand_mult": 3.0,
            "ddos_add": 300.0,
            "message": "Retailers are pushing huge digital sales. Legitimate traffic is surging, but watch out for mixed-in malicious attacks!",
            "seen_before": false,
            "event_is_good": true
        },
        "quarterly_earnings": {
            ...
            "demand_mult": 1.5,
            "ddos_add": 0.0,
            "message": "Corporate clients are broadcasting live earnings calls. Expect a steady, elevated stream of high-priority traffic today.",
            "seen_before": false,
            "event_is_good": true
        },
        "major_os_update": {
            ...
            "demand_mult": 1.8,
            "ddos_add": 0.0,
            "message": "WindOs 12 just dropped. Millions of devices are pulling background downloads. Bandwidth demand will surge.",
            "seen_before": false,
            "event_is_good": true
        },
        "end_of_month_backups": {
            ...
            "demand_mult": 2.2,
            "ddos_add": 0.0,
            "message": "Enterprise clients are running massive end-of-month data backups. Expect heavy write operations and dense storage traffic.",
            "seen_before": false,
            "event_is_good": true
        },
        ...
        "botnet_attack": {
            ...
            "demand_mult": 1,
            "ddos_add": 800,
            "message": "RED ALERT: Massive global botnet detected. Junk traffic is flooding inbound ports. Enable mitigation immediately!",
            "seen_before": false,
            "event_is_good": false
        },
        "viral_video": {
            ...
            "demand_mult": 1.5,
            "ddos_add": 0.0,
            "message": "A tech influencer just reviewed a hosted service! Incoming sudden spike in web traffic from curious viewers.",
            "seen_before": false,
            "event_is_good": true
        },
        "competitor_outage": {
            ...
            "demand_mult": 2.0, 
            "ddos_add": 0.0,
            "message": "A rival cloud provider had an outage. Panicked businesses are migrating workloads to us. Get ready for an influx!",
            "seen_before": false,
            "event_is_good": true
        },
        "crypto_boom": {
            ...
            "demand_mult": 3.0,
            "ddos_add": 0.0,
            "message": "Market surge! Miners are renting all available compute power. Expect sustained, high CPU utilization.",
            "seen_before": false,
            "event_is_good": true
        },
        "pr_disaster": {
            ...
            "demand_mult": 0.5, 
            "ddos_add": 0.0,
            "message": "A false data leak rumor is trending. Startled clients are pausing traffic. Expect a sharp drop in utilization.",
            "seen_before": false,
            "event_is_good": false
        },
        "zero_day_exploit": {
            ...
            "demand_mult": 1.0,
            "ddos_add": 2500.0, 
            "message": "CRITICAL: Global Zero-Day exploit targeting our infrastructure! Malicious packets are flooding the network.",
            "seen_before": false,
            "event_is_good": false
        },
        "fiber_cut": {
            ...
            "demand_mult": 0.2, 
            "ddos_add": 0.0,
            "message": "Disaster! A construction crew severed a primary fiber uplink. Traffic is severely bottlenecked until repairs finish.",
            "seen_before": false,
            "event_is_good": false
        },
        "indie_game_launch": {
            ...
            "demand_mult": 2.5, 
            "ddos_add": 0.0,
            "message": "An indie game hosted here went viral! Hundreds of thousands of players are logging in. Expect massive traffic.",
            "seen_before": false,
            "event_is_good": true
        },
        "scraper_swarm": {
            ...
            "demand_mult": 1.0, 
            "ddos_add": 800.0, 
            "message": "Aggressive AI scraping bots detected. Massive volume of rapid-fire requests is creating a wave of junk traffic.",
            "seen_before": false,
            "event_is_good": false
        }
    }
